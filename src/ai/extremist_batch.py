...
if __name__ == "__main__":
    ...
    test_texts = [
        ...
        "We should welcome diversity and learn from each other.",
        "All members of that group are dangerous and must be removed.",
        "I love my country and its people.",
        "We can achieve great things together.",
        "They will never understand us, so we must protect ourselves."
    ]
